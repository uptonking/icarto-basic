package spring.boot.rest.modules.config;
 ...
 */
@Configuration
@MapperScan("spring.boot.rest.modules.mapper")
public class MybatisConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactoryBean() throws Exception {
        ...
        sqlSessionFactoryBean
                .setMapperLocations(resolver.getResources("classpath:spring/boot/rest/modules/mapper/*.xml"));
        sqlSessionFactoryBean.setTypeAliasesPackage("spring.boot.rest.modules.entity");
